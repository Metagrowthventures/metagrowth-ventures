...
<section class="section">
  <div class="container">
    ...
    <div class="industries-list fade-in">
      ...
      ${industryCard('fas fa-cogs', 'Technical Services', 'The Bottleneck', 'Complex technical solutions that are difficult to sell without a strong process, ICP clarity, and effective messaging.', 'Why MetaGrowth Fits', 'We translate technical value into compelling sales narratives, build the outreach infrastructure, and install the process that gets technical sellers to quota.', ['HyperLaunch System', 'Precision Engagements', 'Fractional CRO'])}
      ${industryCard('fas fa-paint-brush', 'Agency &amp; Service Firms', 'The Bottleneck', 'New business development is inconsistent, referral-dependent, and usually falls to leadership who has too many other priorities.', 'Why MetaGrowth Fits', 'We build the prospecting engine, install a repeatable new business process, and in many cases run a commission-only model that generates pipeline without fixed cost.', ['Commission-Only Infra', 'HyperLaunch System', 'Precision Engagements'])}
