      ...
      <div data-result="s1" style="display:block;">
        <div class="dt-result-inner">
          <div class="dt-result-left">
            ...
            <a href="https://meetings.hubspot.com/josh549/revenue-audit" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Get My Recommended Path</a>
          </div>
        ...
        <div class="dt-result-inner">
          ...
          <div class="dt-result-right">
            ...
            <div class="dt-rec-card dt-rec-card--highlight">
              ...
              <a href="https://meetings.hubspot.com/josh549/revenue-audit" target="_blank" rel="noopener noreferrer" class="dt-rec-link">Apply to the Program →</a>
            </div>
          </div>
        </div>
      </div>
...
<section class="cta-section">
  <div class="container">
    ...
    <div class="cta-row">
      <a href="https://meetings.hubspot.com/josh549/revenue-audit" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-lg">
        <i class="fas fa-calendar-check"></i> Book a Strategy Call
      </a>
